...
//http://the_bloom_studio.com
function get_domain()
{
    $protocol = getProtocol();
    return $protocol . $_SERVER['HTTP_HOST'];
}
//http://the_bloom_studio.com/site
...
{
    // chuyển ngày tháng năm thành con số nguyên tính từ lúc 0h, 0p, 0s ngày 01/01/1970
